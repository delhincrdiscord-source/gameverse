...
import { checkEventConflict } from "../_actions/event";
import type {
  CreateEventInput,
...
export default function CreateEventPage() {
  ...
  }, [formData.startDate, formData.endDate, formData.discordVoiceChannelId]);
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Add a new community event to your festival
          </p>
        </div>
      </div>
